...
- (UILabel *)countJump {
    if (!_countJump) {
        ...
        _countJump.textColor = UIColorFromHex(0xd63131);
        _countJump.font = [UIFont boldSystemFontOfSize:48];
