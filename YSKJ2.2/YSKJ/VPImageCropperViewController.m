...
//    self.overlayView.backgroundColor = [UIColor blackColor];
    ...
    if ([self.forVC isEqualToString:@"1"]) {
        
        self.ratioView.layer.borderColor = [UIColor clearColor].CGColor;
    }else{
        UIColor *borderCol=UIColorFromHex(0xf39800);
        self.ratioView.layer.borderColor = borderCol.CGColor;
    }
...
- (void)initControlBtn {
    ...
    if ([self.forVC isEqualToString:@"1"]) {
        [confirmBtn setTitle:@"上传" forState:UIControlStateNormal];
    }else{
